package day38_collections_maps;
...
public class C03_ArraydenTekrarEdenElementleriSilme {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Array'in son hali : " + Arrays.toString(arr));//Burada düzenledik ama arrayimiz halen ayni!

        arr = new int[benzersizSet.size()];

        // Set index kullanmaz, dolayisiyla kendi index'imizi tanimlayip for each döngüsü ile cagirmaliyiz.
