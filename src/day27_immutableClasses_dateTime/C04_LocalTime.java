...
public class C04_LocalTime {
    ...
    public static void main(String[] args) {
        ...
        // .get..  localTime degerindeki saat,dakika,saniye veya nano saniyeyi bize getirir

        System.out.println(Duration.between(localTimeBaslangic, localTimeBitis)); // PT11.355606S tam deger aliriz cunku yukarida bazen eksi degerler olabilir

        // .with..  localTime degerindeki saat,dakika,saniye veya nanosaniyeyi
        // istedigimiz deger olarak ayarlar
        System.out.println(localTimeBitis.withHour(20)); // 20:14:32.627315 gercek saat yerine 20 yazar
        System.out.println(localTimeBitis.withMinute(0));  // 12:00:32.347180 gercek dakika yerine 0  yazar
        System.out.println(localTimeBitis.withSecond(0).withNano(0)); // 12:16  saniye ve nano saniyeyi sifir yapip atar

        // .plus.. veya .minus..  localTime degerindeki saat,dakika,saniye veya nanosaniyeyi
        // istedgimiz deger kadar ileri veya geriye alir

        System.out.println(localTimeBitis.plusHours(29).plusMinutes(17)); //29 saat ve 17 dakika sonra ya götürür
        // 17:35:41.298407

        System.out.println(localTimeBitis.minusHours(217)); // 11:18:41.298407 217 saat geriye gidiyoruz
